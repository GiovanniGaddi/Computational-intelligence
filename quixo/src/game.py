...
class Game(object):
    ...
    def play(self, player1: Player, player2: Player) -> int:
        ...
        winner = -1
        #counter in case of draw
        drawCnt = 500
        while winner < 0 and drawCnt >0:
            self.current_player_idx += 1
    ...
    def __move(self, from_pos: tuple[int, int], slide: Move, player_id: int) -> bool:
        ...
        if acceptable:
            ...
            if not acceptable:
                ...
                print(f'{self.current_player_idx:02d}-Slide not Acceptable', from_pos, slide)

        else:
            print('Coords not Acceptable', from_pos, slide)
        return acceptable
